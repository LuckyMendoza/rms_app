          ...
          <div class="col-lg-6">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <h1 class="mb-4">
                ...
                <span class="accent-text">With RMS</span>
              </h1>

              <p class="mb-4 mb-md-5">
                RMS helps you boost productivity by organizing and managing your documents efficiently. Streamline workflows, secure sensitive files, and access your records anytime, anywhere with our user-friendly document management solution.
              </p>

              <div class="hero-buttons">
                <a href="index.html#about" class="btn btn-primary me-0 me-sm-2 mx-1">Get Started</a>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <h4>99.9% Uptime</h4>
                <p class="mb-0">Reliable document access</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <h4>50% Less Time</h4>
                <p class="mb-0">In document processing</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <h4>100% Secure</h4>
                <p class="mb-0">Document protection</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            <div class="stat-item">
              ...
              <div class="stat-content">
                <h4>24/7 Support</h4>
                <p class="mb-0">Always ready to help</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 align-items-center justify-content-between">
          ...
          <div class="col-xl-5" data-aos="fade-up" data-aos-delay="200">
            <span class="about-meta"> EXPLORE ABOUT-> </span>
            <h2 class="about-title">Revolutionizing Document Management for Modern Businesses</h2>
            <p class="about-description">At RMS, we understand the challenges of managing growing volumes of documents and records. Our system was developed to eliminate the chaos of paper-based processes, reduce storage costs, and ensure regulatory compliance while making your documents instantly accessible. We've designed RMS to be intuitive enough for beginners yet powerful enough for enterprise-level document management needs.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row content justify-content-center align-items-center position-relative">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <a href="index.html#" class="btn btn-cta">Call To Action</a>
          </div>
        ...
        <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-10">
            <div class="text-center">
              ...
              <a class="cta-btn" href="index.html#">Call To Action</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row g-4 g-lg-5">
          ...
          <div class="col-lg-7">
            <div class="contact-form" data-aos="fade-up" data-aos-delay="300">
              ...
              <form action="https://themewagon.github.io/iLanding/forms/contact.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="200">
                <div class="row gy-4">
